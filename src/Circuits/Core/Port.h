...
public:
	virtual inline PortType GetType() const = 0;
	virtual inline unsigned GetConnectorsCount() const { return (unsigned)connectors.size(); }
...
public:
	...
	virtual inline PortType GetType() const override { return Bit; }
};